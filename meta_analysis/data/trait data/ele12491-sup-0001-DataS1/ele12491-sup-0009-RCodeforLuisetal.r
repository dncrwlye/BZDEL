...
setwd("~/Dropbox (Personal)/PROJECTS/Belize/Hemoplasma NeoCom/ele12491-sup-0001-DataS1")
...
tree=read.tree("ele12491-sup-0010-MammalianSupertree.txt")
...
setwd("~/Dropbox (Personal)/PROJECTS/Belize/Hemoplasma NeoCom/ele12491-sup-0001-DataS1/TERRESTRIAL_MAMMALS")
mammterr=readShapeSpatial("TERRESTRIAL_MAMMALS.shp") 
...
models=c("y~phylo","y~cit","y~phylo+cit")
MRM.table(models)
