...
load('R/filo and hnv positive factorization/Z.hnv.pos')
load('R/filo and hnv positive factorization/bat_tree.hnv.pos')
...
ecdf(S[,1])(Obj[1])
save(list=ls(),file='R/filo and hnv positive factorization/hnv_workspace')
load(file='R/filo and hnv positive factorization/hnv_workspace')
