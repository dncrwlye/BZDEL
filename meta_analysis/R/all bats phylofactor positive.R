...
pf.tree.hnv.pos <- pf.tree(pf.hnv_pos, lwd=1, factors = 7, color.fcn = colfcn.hnv.pos, branch.length = "none") #again, its easier to make the tree and just assign a factor that is really hard to see, since none are signigant, than actually make a tree wtih no factors
